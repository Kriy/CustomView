package com.lemon.customview.widget.Heart;
...
public class MeiHeartView extends View {
    ...
    private SparseArray<NewHeart> mHeartArray = new SparseArray<>();
    ...
    public void addHeart(final int index) {
        ...
        final NewHeart heart = new NewHeart();
        heart.index = index;
    ...
    private void canvasHeart(Canvas canvas) {
        for (int i = 0; i < mHeartArray.size(); i++) {
            ...
            NewHeart heart = mHeartArray.valueAt(i);
