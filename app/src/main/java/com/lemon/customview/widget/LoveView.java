...
public class LoveView extends RelativeLayout {
    ...
    private void init() {
        ...
        mDrawables[0] = ContextCompat.getDrawable(getContext(), R.mipmap.pl_blue);
        mDrawables[1] = ContextCompat.getDrawable(getContext(), R.mipmap.pl_red);
        mDrawables[2] = ContextCompat.getDrawable(getContext(), R.mipmap.pl_yellow);
